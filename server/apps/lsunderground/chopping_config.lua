_models = {
    Normal = {
        ...
        { model = `mesa3`, name = 'Messa Offroad' },
...
_lootTables = {
    ...
    materials = {
        ...
        { 15, { name = "plastic", min = 5, max = 30 } },
        { 15, { name = "rubber", min = 4, max = 26 } },
        { 15, { name = "copperwire", min = 18, max = 54 } },
        { 15, { name = "glue", min = 3, max = 24 } },
        { 15, { name = "heavy_glue", min = 3, max = 24 } },
        { 10, { name = "ironbar", min = 3, max = 20 } },
    },
}
...
_boxTables = {
    ...
    materials = {
        { 15, { name = "electronic_parts", min = 250, max = 500 } },
        { 15, { name = "plastic", min = 100, max = 200 } },
        { 15, { name = "rubber", min = 100, max = 200 } },
        { 15, { name = "copperwire", min = 200, max = 400 } },
        { 15, { name = "glue", min = 100, max = 200 } },
        { 15, { name = "heavy_glue", min = 100, max = 200 } },
        { 10, { name = "ironbar", min = 100, max = 200 } },
    },
}
...
_chopDropoffs = {
    ...
    {
        coords = vector3(88.37, 6544.54, 31.68),
        length = 27.4,
        width = 14.8,
        options = {
            name = "chopdrop-10",
