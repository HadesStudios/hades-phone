...
export default (props) => {
    ...
    const playerJobData = jobs.find(job => job.Id == jobId);
	const jobData = Array.isArray(AllJobData) ? AllJobData.find(j => j.Id == playerJobData?.Id) : (AllJobData?.Id == playerJobData?.Id ? AllJobData : null);
