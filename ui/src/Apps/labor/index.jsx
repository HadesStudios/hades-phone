					...
					if (process.env.NODE_ENV !== 'production') {
						setJobs({
							mining: {
								Id: 'mining',
								Name: 'Mining',
								Description: 'Extract valuable minerals from designated mining sites',
								Restricted: false,
								Limit: 4,
								Cooldown: 300000,
								Salary: 150,
							...
							hunting: {
								Id: 'hunting',
								Name: 'Hunting',
								Description: 'Track and hunt wildlife in designated hunting zones',
								Restricted: false,
								Limit: 2,
								Cooldown: 600000,
								Salary: 200,
							...
							fishing: {
								Id: 'fishing',
								Name: 'Fishing',
								Description: 'Catch fish at various fishing spots around the city',
								Restricted: false,
								Limit: 3,
								Cooldown: 450000,
								Salary: 125,
